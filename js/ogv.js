                ...
                $.each(areas, function (pos, object) {
                    if (object.Area != "General" && object.Area != "Totales") {
                        ...
                        boards.append(
                            ...
                            "<div id='p-comp4' class='progress-bar bg-prmary' role='progressbar' style='width: " + (100 / (dataBoard.Avance[10].Compromiso4) * object.Compromiso4) + "%" + "' aria-valuenow='75' aria-valuemin='0' aria-valuemax='100'></div>" +
                            "</div>" +
                            "</div>" +
                            "<div class='avance-area'>" +
